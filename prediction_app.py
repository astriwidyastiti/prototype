...
image_path_logo=os.path.join(dirname,'logo.png')
col1, col2 = st.columns([1, 5])
with col1:
    st.image(image_path_logo, width=150,use_column_width='auto')
with col2:
    st.markdown('# **Institution App (Prototype)**')
# Personal Information Section
# st.image.os.path.join(dirname,'logo.png')


image_path_personal=os.path.join(dirname,'personal.png')
col1, col2 = st.columns([1, 5])
with col1:
    st.image(image_path_personal, width=50)
with col2:
...
image_path_application=os.path.join(dirname,'application.png')
col1, col2 = st.columns([1, 5])
with col1:
    st.image(image_path_application, width=50)
with col2:
...
image_path_financial=os.path.join(dirname,'financial.png')
col1, col2 = st.columns([1, 5])
with col1:
    st.image(image_path_financial, width=50, use_column_width='auto')
with col2:
    st.markdown("## **Financial Information**",unsafe_allow_html=True)
...
# Student Progress
image_path_student=os.path.join(dirname,'student.png')
col1, col2 = st.columns([1, 5])
with col1:
    st.image(image_path_student, width=100)
with col2:
    st.markdown("## **Student Progress**")
# image_path_student=os.path.join(dirname,'student.png')
# col1, col2, col3 = st.columns([1, 5,])
# with col1:
#     st.image(image_path_student, width=50)
# with col2:
#     st.markdown("## **Student Progress**")
...
with col2:
    if st.button('Predict'):
        new_data = data_preprocessing(data=data_df)
        with st.expander("### **View the Preprocessed Data**"):
            st.dataframe(data=new_data, width=1500)
